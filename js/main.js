...
const TRANSLATIONS = {
    ...
    en: {
        ...
        'index.projects.kabak.title': 'Pumpkin Seed Trade',
        'index.projects.kabak.desc': 'High-quality Ukrainian-origin pumpkin seeds for food and industrial use',
        ...
        'kabak.hero.title': 'Pumpkin Seed <span>Trade</span>',
        'kabak.hero.subtitle': 'High-quality Ukrainian-origin pumpkin seeds — The Right Product, The Right Price, Reliable Supply.',
        'kabak.img.alt': 'Ukrainian-origin pumpkin seeds',
        'kabak.section.offer.title': 'Our Clear Offer',
        'kabak.section.offer.desc': 'There are only two options in the market: cheap but risky products, or expensive and unstable supply. We offer a third option: High quality + competitive pricing + reliable shipment.',
        'kabak.section.product.title': 'Product Strength',
        'kabak.section.product.item1': 'Ukrainian origin with high kernel fill rate',
        'kabak.section.product.item2': 'Homogeneous sizing, low waste',
        'kabak.section.product.item3': 'Organic production available',
        'kabak.section.product.item4': 'Suitable for food and industrial use',
        'kabak.section.product.desc': 'This product improves both shelf performance and processing efficiency.',
        'kabak.section.clients.title': 'Who We Sell To',
        'kabak.section.clients.item1': 'Nut processors (high volume)',
        'kabak.section.clients.item2': 'Packaged food brands (value-added)',
        'kabak.section.clients.item3': 'Oil producers (high yield)',
        'kabak.section.clients.item4': 'Traders (fast turnover)',
        'kabak.section.clients.desc': 'Our product doesn\'t sit in stock; it moves fast in the right channels.',
        'kabak.section.supply.title': 'Supply Reality',
        'kabak.section.supply.item1': 'Shipment in required quantities (trial → contract)',
        'kabak.section.supply.item2': 'Continuous supply, not one-off deals',
        'kabak.section.supply.item3': 'Fast loading',
        'kabak.section.supply.item4': 'Flexible packaging and delivery terms',
        'kabak.section.supply.desc': 'We don\'t promise and delay – we load and deliver.',
        'kabak.section.turkey.title': 'The Smart Choice for Türkiye',
        'kabak.section.turkey.item1': 'Geographic advantage → fast delivery',
        'kabak.section.turkey.item2': 'Lower logistics cost',
        'kabak.section.turkey.item3': 'European quality with competitive pricing',
        'kabak.section.turkey.item4': 'One of the most optimized sourcing options for the Turkish market.',
        'kabak.section.why.title': 'Why Us?',
        'kabak.section.why.item1': 'Real price/quality balance',
        'kabak.section.why.item2': 'Sustainable supply',
        'kabak.section.why.item3': 'Fast communication, clear offers',
        'kabak.section.why.item4': 'Not a time-waster – a business enabler.',
        'kabak.section.conclusion.title': 'Conclusion',
        'kabak.section.conclusion.intro': 'If your goal is to:',
        'kabak.section.conclusion.item1': 'Buy quality at competitive prices',
        'kabak.section.conclusion.item2': 'Avoid supply risk',
        'kabak.section.conclusion.item3': 'Build long-term partnerships',
        'kabak.section.conclusion.desc': '→ You are in the right place.',
        'kabak.section.contact.title': 'Contact',
        'kabak.section.contact.desc': 'Contact us for quick quotation and samples.',
